...
read_verilog -library xil_defaultlib -sv {
  ...
  {D:/Backup Alan Wilson/Repos/POWERLAB-UTFSM/AX7020_PWM_test/PWM_test_Vivado/PWM_test_Vivado.srcs/sources_1/new/div_pwm_clock.sv}
...
synth_design -top pwm_16bits -part xc7z020clg400-2
...
write_checkpoint -force -noxdef pwm_16bits.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file pwm_16bits_utilization_synth.rpt -pb pwm_16bits_utilization_synth.pb"
